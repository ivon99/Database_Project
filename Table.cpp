...
void Table::describe()const
{
  ...
  {
    cout<<"Column #"<<i<<": "<<m_table[i]->getNameColumn()<<" is of type "<<m_table[i]->getType()<<"."<<endl;
  }
}
...
void Table::count() const
{
 ...
 bool Table::addColumn(const char* colname, const char* type)
 {
   ...
   if(strcmp(type,"string")==0)
   {
     ...
     cout<<"String column to be added?"<<endl;
     return true;
   }
   if(strcmp(type,"int")==0)
   {
     ...
     m_table.addElement(col);
     cout<<"Int column to be added?"<<endl;
     return true;
   }
   if(strcmp(type,"double")==0)
   {
     ...
     m_table.addElement(col);
     cout<<"Double column to be added?"<<endl;
     return true;
   }
   else
   {
   ...
   for(int i=0; i<size_col;i++)
   {
     if(m_table.getElement(col_index)->getIntElement(i)==value)
     {
           for(int j=0; j<num_col; j++)
           {
              ...
              if(strcmp(type,"int")==0)
              {
              cout<<m_table.getElement(j)->getIntElement(i)<<" ";
              }
              if (strcmp(type, "double") == 0)
              {
                cout<<m_table.getElement(j)->getDoubleElement(i)<<" ";
              }
              if (strcmp(type, "string") == 0)
              {
                cout<<m_table.getElement(j)->getStringElement(i)<<" ";
              }
           } 
           cout<<endl;
     }
...
/*
  ...
  Table& readTableFromFile(std::ifstream& infile, Table& obj){
    cout<<"Im inside importtable function"<<endl;
     //==imports tablename==
     int tablename_size;
     ...
     cout<<"Succesfully read tablename "<< obj.m_tablename<<endl;
     ...
     int num_col;
     infile>>num_col;
     cout<<"Dimensions of table are "<<num_rows<<"X"<<num_col<<endl; 
    ...
    char* type= new char[7];
     ...
     for(int i=0; i<num_col;i++){
       ...
       infile>>colname;
       infile>>type;
       cout<<"To add column name of type"<<colname<<" t:" <<type<<endl;
       obj.addColumn(colname,type);
       cout<<"Added column.Table now has:\n";
       obj.describe();
     }
     ...
     for (int i=0;i<num_rows;i++)
     {
       for(int j=0; j<num_col;j++)
       {
         ...
         if(strcmp(type,"int")==0)
        {
          int value;
          infile>> value;
          cout<< "["<<i<<"]["<<j<<"] put int value"<<value<<endl;
        ...
        if(strcmp(type,"double")==0)
        {
          double value;
          infile>>value;
          cout<< "["<<i<<"]["<<j<<"] put double value"<<value<<endl;
        ...
        if(strcmp(type,"string")==0)
        {
          char* text=new char[100];
           infile>>text; 
            cout<< "["<<i<<"]["<<j<<"] put string text "<<text<<endl;
...
void writeTableToFile(std::ofstream& outfile, Table& obj)
{
  cout<<"Im inside writeTabletoFile function"<<endl;
    ...
    for(int i=0; i<num_col;i++)
    {
      ...
      cout<<"Wrote columns and their types"<<endl;
     ...
     for (int i=0;i<num_rows;i++)
     {
       for(int j=0; j<num_col;j++)
       {
        ...
        if(strcmp(type,"double")==0)
        {
          ...
          outfile<<element<<" ";
          cout<< "["<<i<<"]["<<j<<"] write double value"<<endl;
          continue;
        }
        if(strcmp(type,"string")==0)
        {
            ...
            outfile<<element<<" ";
            cout<< "["<<i<<"]["<<j<<"] write strig value"<<endl;
            continue;
        }
      }
      outfile<<endl;
